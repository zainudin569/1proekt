...
void DrawGirl   (int x, int y, float sizeX, double sizeY, COLORREF GirlColor,
...
int main()
    ...
    while (t <=100)
        {
        txClear ();
        DrawBackground (RGB (0, 180 - pow(t-50,2)/25, 180 - pow(t-50,2)/25));
        DrawSun    (  7 + 5*t,               75 + pow(t-50,2)/100*3,
                    1.2 - pow(t-50,2)/2000, 1.2 - pow(t-50,2)/2000,
...
void DrawGirl  (int x, int y, float sizeX, double sizeY, COLORREF GirlColor,
    ...
    POINT Girl [3] = {{x + 15*sizeX, y + 30*sizeY}, {x + 5*sizeX, y + 75*sizeY},
                      {x + 25*sizeX, y + 75*sizeY}};
    txPolygon (Girl, 3);
    txSetColor (RGB (255, 128, 0), 1);
    txSetFillColor (RGB (255, 0, 0));
    POINT Girl2 [3] = {{x +  7*sizeX, y + 20*sizeY}, {x + 15*sizeX, y + 20*sizeY + smayl},
                       {x + 23*sizeX, y + 20*sizeY}};
    txPolygon (Girl2, 3);
    txSetColor (RGB (200, 200, 0), 1);
    txSetFillColor (RGB (200, 200,   0));
    txEllipse (x +  7*sizeX, y + 7*sizeY, x + 13*sizeX*Glaz, y + 13*sizeY*Glaz);
    txEllipse (x + 17*sizeX, y + 7*sizeY, x + 23*sizeX*Glaz, y + 13*sizeY*Glaz);
    }
...
void DrawTree1 (int x, int y, double sizeX, double sizeY, COLORREF TreeColor)
    ...
    POINT Tree [4] = {{ x + 35*sizeX, y + 92*sizeY}, {x + 35*sizeX, y + 117*sizeY},
                       {x + 57*sizeX, y+ 117*sizeY}, {x + 57*sizeX, y +  92*sizeY}};
    txPolygon (Tree, 4);
...
void DrawTree2 (int x, int y, double sizeX, double sizeY, COLORREF TreeColor)
    ...
    {
    txSetFillColor (TreeColor);
    POINT Tree2 [7] = {{x,             y},            {x + 37*sizeX, y}, {x + 37*sizeX, y + 30*sizeY},
                       {x +  63*sizeX, y + 30*sizeY}, {x + 63*sizeX, y},
                       {x + 100*sizeX, y},            {x + 50*sizeX, y - 88*sizeY}};
    txPolygon (Tree2, 7);
    }
...
void DrawSun   (int x, double y, double sizeX, double sizeY, COLORREF SunColor)
    ...
    POINT Sun [8] = {{x -  2*sizeX, y - 50*sizeY}, {x - 37*sizeX, y + 35*sizeY}, {x + 50*sizeX, y},
                     {x - 37*sizeX, y - 35*sizeY}, {x -  2*sizeX, y + 50*sizeY}, {x + 33*sizeX, y - 35*sizeY},
                     {x - 50*sizeX, y           }, {x + 33*sizeX, y + 35*sizeY}};
    txPolygon (Sun, 8);
...
void DrawHouse1 (int x, int y, COLORREF HoleColor)
    ...
    POINT stena [4] = {{x, y}, {x - 120, y}, {x - 120, y - 140}, {x, y - 140}};
    txPolygon (stena, 4);

    txSetFillColor (RGB (0, 0, 0));
    POINT Window1 [4] = {{x - 110, y - 120}, {x - 110, y - 100}, {x - 90, y - 100}, {x - 90, y - 120}};
    txPolygon (Window1, 4);

    POINT Window2 [4] = {{x - 70, y - 120}, {x - 70, y - 100}, {x - 50, y - 100}, {x - 50, y - 120}};
    txPolygon (Window2, 4);

    POINT Window3 [4] = {{x - 30, y - 120}, {x - 30, y - 100}, {x - 10, y - 100}, {x - 10, y - 120}};
    txPolygon (Window3, 4);
...
void DrawHouse2 (int x, int y)
    ...
    txSetFillColor (RGB (255, 0, 0));
    POINT Roof [3] = {{x, y}, {x + 60, y - 30}, {x + 130, y}};
    txPolygon (Roof, 3);

    txSetFillColor (RGB (150, 0, 0));
    POINT stena [4] = {{x + 20, y}, {x + 20, y + 117}, {x + 110, y + 117}, {x + 110, y}};
    txPolygon (stena, 4);

    txSetFillColor (RGB (0, 0, 0));
    POINT Window1 [4] = {{x + 30, y + 40}, {x + 30, y + 20}, {x + 55, y + 20}, {x + 55, y + 40}};
    txPolygon (Window1, 4);

    POINT Window2 [4] = {{x + 90, y + 25}, {x + 90, y + 10}, {x + 105, y + 10}, {x + 105, y + 25}};
    txPolygon (Window2, 4);

    POINT Window3 [4] = {{x + 90, y + 55}, {x + 90, y + 40}, {x + 105, y + 40}, {x + 105, y + 55}};
    txPolygon (Window3, 4);
